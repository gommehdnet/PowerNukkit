...
public enum Sound {
    ...
    JUMP_METAL("jump.metal"),
    MOB_PIGLIN_ATTACK("mob.piglin.attack"),
    USE_POWDER_SNOW("use.powder_snow"),
    USE_BIG_DRIPLEAF("use.big_dripleaf"),
    USE_AZALEA_LEAVES("use.azalea_leaves"),
    USE_AZALEA("use.azalea"),
    ...
    CLICKING_STOP_SCULK_SENSOR("clicking_stop.sculk_sensor"),
    SPREAD_SCULK("spread.sculk"),
    CHARGE_SCULK("charge.sculk"),
    CLICKING_SCULK_SENSOR("clicking.sculk_sensor"),
