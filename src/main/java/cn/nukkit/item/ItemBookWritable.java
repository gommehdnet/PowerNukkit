...
public abstract class ItemBookWritable extends Item {
    ...
    protected ItemBookWritable(ItemID id) {
        super(id);
    }

    protected ItemBookWritable(ItemID id, Integer meta) {
        super(id, meta);
    }

    protected ItemBookWritable(ItemID id, Integer meta, int count) {
        super(id, meta, count);
    }

    protected ItemBookWritable(ItemID id, Integer meta, int count, String name) {
