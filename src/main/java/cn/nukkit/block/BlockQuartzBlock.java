 ...
 */
public class BlockQuartzBlock extends BlockSolidMeta {
    ...
    public BlockQuartzBlock(int meta) {
        super(meta);
    }

    @Override
    public BlockID getId() {
        return BlockID.QUARTZ_BLOCK;
    }
    ...
    @Override
    public Item toItem() {
        return Item.get(ItemID.QUARTZ_BLOCK, this.getDamage());
    }
