 ...
 * @version 1.0
 */
public class BlockLargeAmethystBud extends BlockTransparentMeta implements Faceable {

    public static final BlockProperties PROPERTIES = new BlockProperties(CommonBlockProperties.FACING_DIRECTION);

    @Override
    public BlockID getId() {
        return BlockID.LARGE_AMETHYST_BUD;
    }
    ...
    @Override
    public Item toItem() {
        return Item.get(ItemID.LARGE_AMETHYST_BUD);
    }
