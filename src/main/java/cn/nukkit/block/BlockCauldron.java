...
public class BlockCauldron extends BlockSolidMeta implements BlockEntityHolder<BlockEntityCauldron> {
    ...
    public boolean onActivate(@Nonnull Item item, Player player) {
        ...
        if (item.getIdentifier().equals(ItemID.BUCKET)) {
            ...
            if (bucket.isEmpty()) {
                ...
                if (!ev.isCancelled()) {
                    ...
                    if (cauldron.hasPotion()) {//if has potion
                        ...
                        if (isEmpty()) {
                            BlockLavaCauldron cauldronLava = new BlockLavaCauldron(0xE);
        ...
        } else if (item.getIdentifier().equals(ItemID.DYE)) { // TODO: Kaooot
            ...
            BlockColor color = new ItemDye(item.getIdentifier(), 0, 1).getDyeColor().getLeatherColor();
        ...
        } else if (item.getIdentifier().equals(ItemID.LEATHER_HELMET) || item.getIdentifier().equals(ItemID.LEATHER_CHESTPLATE) ||
                item.getIdentifier().equals(ItemID.LEATHER_LEGGINGS) || item.getIdentifier().equals(ItemID.LEATHER_BOOTS) || item.getIdentifier().equals(ItemID.LEATHER_HORSE_ARMOR)) {
            if (isEmpty() || cauldron.hasPotion()) {
                return false;
            }
        ...
        } else if (item.getIdentifier().equals(ItemID.POTION) || item.getIdentifier().equals(ItemID.SPLASH_POTION) || item.getIdentifier().equals(ItemID.LINGERING_POTION)) {
            ...
            cauldron.setType(
                    item.getIdentifier() == ItemID.POTION ? BlockEntityCauldron.PotionType.NORMAL :
                            item.getIdentifier() == ItemID.SPLASH_POTION ? BlockEntityCauldron.PotionType.SPLASH :
        ...
        } else if (item.getIdentifier().equals(ItemID.GLASS_BOTTLE)) {
            if (isEmpty()) {
                return false;
            }
            ...
            if (meta == 0) {
                ...
                switch (cauldron.getType()) {
                    case SPLASH:
                        potion = new ItemSplashPotion(meta);
                        break;
                    case LINGERING:
                        potion = new ItemLingeringPotion(meta);
                        break;
                    case NORMAL:
                    default:
        ...
        } else if (item.getIdentifier().equals(ItemID.BANNER)) {
