...
public class BlockDoubleStoneBlockSlab3 extends BlockDoubleSlabBase {
    ...
    @PowerNukkitOnly
    public BlockDoubleStoneBlockSlab3(int meta) {
        super(meta);
    }

    @Override
    public BlockID getId() {
        return BlockID.DOUBLE_STONE_BLOCK_SLAB3;
    }
    ...
    public BlockProperties getProperties() {
        return BlockStoneBlockSlab3.PROPERTIES;
    }
    ...
    @Override
    public Item toItem() {
        return Item.get(ItemID.STONE_BLOCK_SLAB3);
    }
