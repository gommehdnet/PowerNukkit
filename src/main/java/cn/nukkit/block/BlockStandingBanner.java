...
import static cn.nukkit.block.BlockStandingSign.GROUND_SIGN_DIRECTION;
...
@Log4j2
public class BlockStandingBanner extends BlockTransparentMeta implements Faceable, BlockEntityHolder<BlockEntityBanner> {
    ...
    public BlockID getId() {
        return BlockID.STANDING_BANNER;
    }
    ...
    public BlockProperties getProperties() {
        return BlockStandingSign.PROPERTIES;
    }
