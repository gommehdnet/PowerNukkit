 ...
 * @author CreeperFace
 */
public class BlockBoneBlock extends BlockSolidMeta implements Faceable {
    ...
    public BlockBoneBlock(int meta) {
        super(meta);
    }

    @Override
    public BlockID getId() {
        return BlockID.BONE_BLOCK;
    }
    ...
    @Override
    public Item toItem() {
        return Item.get(ItemID.BONE_BLOCK);
    }
}
