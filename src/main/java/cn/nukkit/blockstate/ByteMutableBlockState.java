...
public class ByteMutableBlockState extends MutableBlockState {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public ByteMutableBlockState(BlockID blockId, BlockProperties properties, byte state) {
    ...
    @PowerNukkitOnly
    @Since("1.4.0.0-PN")
    public ByteMutableBlockState(BlockID blockId, BlockProperties properties) {
